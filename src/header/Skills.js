    ...
    return(    
        ...
        <div className="skills-div">
            <div  className="skills" style={{opacity: visible ? '1' : '0'}}>
                ...
                <Skill img={path + '/skills/logo-java.png'} title="Java" list={["Polymorphism","Exceptions","Interfaces","Threads","Lambdas","Enums","Access Control","Data Structures","J2EE","Servlets","Maven","Gradle"]}/>
