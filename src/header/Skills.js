    ...
    return(    
        ...
        <div className="skills-div">
            ...
            <div className="skills">
                ...
                <Skill img={path + '/skills/logo-javascript.png'} title="JavaScript" list={["Functions","Classes","Objects","Lambdas","Destructuring","DOM","Arrays","JQuery"]}/>
            ...
            <h1 className="skills-title">{fi.skills2}</h1>
                ...
                <Skill img={path + '/skills/logo-react.png'} title="React" list={["Components","State","Props","JSX","Hooks"]}/>
